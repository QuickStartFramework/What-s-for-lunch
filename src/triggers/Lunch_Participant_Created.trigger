trigger Lunch_Participant_Created on Lunch_Participant__c (after insert) {
    try {
        ...
        System.debug('Lunch Management - An exception occured after the lunch participant has been created, m=' + ex.getMessage());
    }
}