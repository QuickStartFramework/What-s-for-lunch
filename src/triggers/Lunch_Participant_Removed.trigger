trigger Lunch_Participant_Removed on Lunch_Participant__c (after delete) {
    try {
        ...
        if (lm == null)
            System.debug('Lunch Management - lunch meetup is null');
    ...
    {
        System.debug('Lunch Management - Error while removing Lunch Participant, m=' + e.getMessage());
    }
}